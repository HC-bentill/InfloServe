      ...
      <div class="row">
        ...
        <div class="col-md-4 ">   
          <div class="img-container" >
            ...
            <div class="overlay">
             <div class="text">Location & Planning</div>
            </div>          
        </div>
  ...
  <section class="home-parallax img-fluid">
      <div class="container">
        <div class="row">
           <div class="col-md-12">
             ...
             <h1 class="font" style="font-size:65px">Video Content of Our Works</h1>
             <div id="underline"></div> <br>
    ...
    <section class="second-parallax img-fluid">
      <div class="container">
        <div class="row">
          <div class="col-md-12" >
            <div class="text-center"> 
              <h1 class="font" style="font-size:65px">Planning Your Big day</h1>
              <div id="underline" class="w3-animate-zoom"></div>
    ...
    <section class="testimonials">
      ...
      <div class="row p-5 text-center">
          <div class="col-lg-4">
            <img class="rounded-circle" src="img/avatar1.jfif" alt="Generic placeholder image" width="120" height="120">
            <h2>Kwadwo Sapong</h2>
            <h5>Businessman</h5>
          ...
          <div class="col-lg-4">
            <img class="rounded-circle" src="img/avatar2.jfif" alt="Generic placeholder image" width="120" height="120">
            <h2>Micheal Antwi</h2>
            <h5>Businessman</h5>
