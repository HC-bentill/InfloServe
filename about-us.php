...
?>
    ...
    <!-- start of Hero -->
    <section class="about-banner img-fluid">
      <div class="container">
        <div class="row about-banner-text">
          <div class="col-md-12">
            <h1 class="font w3-animate-right">About us</h1>
          </div>
        </div>
      </div>
    </section>
...
<section class="founders m-5">
<div class="container">
<h1 class="text-center font">Meet The Founder</h1>
<hr>
    ...
    <div class="col-md-6">
      ...
      <ul class="w3-ul w3-card-4 m-2" style="width:90%">
        <li>Quality – exceptional quality delights our customers and is essential to customer growth and retention.</li>
          <li>Service – at Infloserv, service is not simply a concept. It’s how we develop and maintain customer loyalty.
            Innovation – it is the driving force behind our long term growth.</li>
          <li>Peak performance – our commitment is to prepare as individuals and as a corporation to do our best.</li>
      </ul>
    </div>
